...
This repository is part of the course "[Jenkins : Automating your delivery pipeline](https://www.coursera.org/learn/cicd-using-jenkins/)" from Coursera Project Network.

It was used to learn how to use the Jenkins CI/CD server.
